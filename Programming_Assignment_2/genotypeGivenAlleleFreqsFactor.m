...
P = alleleFreqs(genotypesToAlleles);

probPerAllelePair = transpose(bsxfun(@times, P(:,1), P(:,2)));

%allelesToGenotypes

E = eye(size(allelesToGenotypes,1),size(allelesToGenotypes,2));
[dummy1, dummmy2, indxHeterozygous] = find(allelesToGenotypes.*(1 - E));

probPerAllelePair(unique(indxHeterozygous)) = probPerAllelePair(unique(indxHeterozygous)).*2.0;

genotypeFactor.val = probPerAllelePair;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
