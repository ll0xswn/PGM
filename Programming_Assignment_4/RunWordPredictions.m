function wordPredictions = RunWordPredictions (allWords, imageModel, pairwiseModel, tripletList)
...
allWords(1)
for i = 1:numWords
    wordPredictions{i} = PredictWord(allWords{i}, imageModel, pairwiseModel, tripletList );
end
