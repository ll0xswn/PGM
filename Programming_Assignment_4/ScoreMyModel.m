function [charAcc, wordAcc] = ScoreMyModel (words, imageModel, pairwiseModel, tripletList)
...
predictions = RunWordPredictions(words, imageModel, pairwiseModel, tripletList);
