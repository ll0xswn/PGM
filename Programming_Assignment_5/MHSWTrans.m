...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
delta =0.0;
%Only compute Pi(x')/Pi(x) for variant 1
% for Variant 2 Pi(x')/Pi(x) cancels out with R(Y=l/X'_Y)/R(Y=l'|X_Y)
% because X_Y=X'_Y
if variant == 1
  delta_vars= selected_vars;
  ...
  for i=1:length(factors)
     ...
     p_acceptance=min(1, exp(delta + log_QY_ratio));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
