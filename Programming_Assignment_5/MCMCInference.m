  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
               min_card=min(edge_factor.card);
               equal_assignments=repmat([1:min_card]',1,length(edge_factor.var));
               values=GetValueOfAssignment(edge_factor,equal_assignments);
               q_ij = sum(values)/sum(edge_factor.val);
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
